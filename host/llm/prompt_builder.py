...
Отвечай ТОЛЬКО валидным JSON без каких-либо пояснений вокруг него, без эмодзи. значения в emotions можешь свободно менять:
{{
...
Правила:
- Сумма всех эмоций = 1.0. не создавай новых эмоций, кроме указанных выше.
